...
CREATE DATABASE DataHaus_BreBase;

USE DataHaus_BrewBase;

CREATE SCHEMA BrewBase AUTHORIZATION dbo 


CREATE TABLE DataHaus_BrewBase.BrewBase.BREWERY (
...
CREATE TABLE DataHaus_BrewBase.BrewBase.TAPROOM (
...
CREATE TABLE DataHaus_BrewBase.BrewBase.STYLE (
...
CREATE TABLE DataHaus_BrewBase.BrewBase.BEER (
  ...
  CONSTRAINT FK_BEER_BREWERY_ID FOREIGN KEY (BREWERY_ID) REFERENCES DataHaus_BrewBase.BrewBase.BREWERY (BREWERY_ID) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT FK_STYLE_STYLE_ID FOREIGN KEY (STYLE_ID) REFERENCES DataHaus_BrewBase.BrewBase.STYLE (STYLE_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
CREATE TABLE DataHaus_BrewBase.BrewBase.PURCHASE (
  PURCHASE_ID INT NOT NULL,
  TAPROOM_ID INT NOT NULL,
  PURCHASE_DATE DATE,
  CONSTRAINT PK_PURCHASE_PURCHASE_ID PRIMARY KEY CLUSTERED (PURCHASE_ID),
  CONSTRAINT FK_PURCHASE_TAPROOM_ID FOREIGN KEY (TAPROOM_ID) REFERENCES DataHaus_BrewBase.BrewBase.TAPROOM (TAPROOM_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
CREATE TABLE DataHaus_BrewBase.BrewBase.PURCHASE_ITEMS (
  PURCHASE_ID INT NOT NULL,
  ...
  CONSTRAINT FK_PURCHASE_ITEMS_PURHCASE_ID FOREIGN KEY (PURCHASE_ID) REFERENCES DataHaus_BrewBase.BrewBase.PURCHASE (PURCHASE_ID) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT FK_PURCHASE_ITEMS_BEER_UPC FOREIGN KEY (BEER_UPC) REFERENCES DataHaus_BrewBase.BrewBase.BEER (BEER_UPC) ON DELETE NO ACTION ON UPDATE NO ACTION
);
